...
class HomeAttendance extends Model
{
 ...
 protected function evaluatePunch($actualIn, $actualOut)
    ...
    public static function logTimeIn($employeeId)
    {
        ...
        // 2️⃣ Prevent duplicate punches within same window
